...
import org.academiadecodigo.academyinvaders.bullets.EnemyBullet;
...
public abstract class Enemy implements Runnable {
  ...
  public void checkIfDestroyed() {
    ...
    if (isDestroyed()) {
      ...
      this.getEnemyPosition().setObject(new Picture(getEnemyPosition().getWidth(), getEnemyPosition().getHeight(),
          "org/academiadecodigo/academyinvaders/GameObjects/assets/ExplosionEffects/exp.1.png"));
      ...
      this.getEnemyPosition().getObject().delete();
      this.getEnemyPosition().setObject(new Picture(getEnemyPosition().getWidth(), getEnemyPosition().getHeight(),
          "org/academiadecodigo/academyinvaders/GameObjects/assets/ExplosionEffects/exp.2.png"));
      this.getEnemyPosition().getObject().draw();
      try {
        Thread.sleep(delay);
      } catch (InterruptedException e) {
      ...
      this.getEnemyPosition().getObject().delete();
      this.getEnemyPosition().setObject(new Picture(getEnemyPosition().getWidth(), getEnemyPosition().getHeight(),
          "org/academiadecodigo/academyinvaders/GameObjects/assets/ExplosionEffects/exp.3.png"));
      this.getEnemyPosition().getObject().draw();
      try {
        Thread.sleep(delay);
      } catch (InterruptedException e) {
      ...
      this.getEnemyPosition().getObject().delete();
      this.getEnemyPosition().setObject(new Picture(getEnemyPosition().getWidth(), getEnemyPosition().getHeight(),
          "org/academiadecodigo/academyinvaders/GameObjects/assets/ExplosionEffects/exp.4.png"));
      this.getEnemyPosition().getObject().draw();
      try {
        Thread.sleep(delay);
      } catch (InterruptedException e) {
      ...
      this.getEnemyPosition().getObject().delete();
      this.getEnemyPosition().setObject(new Picture(getEnemyPosition().getWidth(), getEnemyPosition().getHeight(),
          "org/academiadecodigo/academyinvaders/GameObjects/assets/ExplosionEffects/exp.5.png"));
      this.getEnemyPosition().getObject().draw();
      try {
        Thread.sleep(delay);
      } catch (InterruptedException e) {
      ...
      this.getEnemyPosition().getObject().delete();
      this.getEnemyPosition().setObject(new Picture(getEnemyPosition().getWidth(), getEnemyPosition().getHeight(),
          "org/academiadecodigo/academyinvaders/GameObjects/assets/ExplosionEffects/exp.6.png"));
      this.getEnemyPosition().getObject().draw();
      try {
        Thread.sleep(delay);
      } catch (InterruptedException e) {
      ...
      this.getEnemyPosition().getObject().delete();
      this.getEnemyPosition().setObject(new Picture(getEnemyPosition().getWidth(), getEnemyPosition().getHeight(),
          "org/academiadecodigo/academyinvaders/GameObjects/assets/ExplosionEffects/exp.7.png"));
      this.getEnemyPosition().getObject().draw();
      try {
        Thread.sleep(delay);
      } catch (InterruptedException e) {
      ...
      this.getEnemyPosition().getObject().delete();
      this.getEnemyPosition().setObject(new Picture(getEnemyPosition().getWidth(), getEnemyPosition().getHeight(),
          "org/academiadecodigo/academyinvaders/GameObjects/assets/ExplosionEffects/exp.8.png"));
      this.getEnemyPosition().getObject().draw();
      try {
        Thread.sleep(1000);
      } catch (InterruptedException e) {
      ...
      Picture gameOver = new Picture(300, 300,
          "org/academiadecodigo/academyinvaders/GameObjects/assets/ExplosionEffects/victory_title.png");
      gameOver.draw();
    }
  }
