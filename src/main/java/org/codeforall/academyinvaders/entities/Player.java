package org.codeforall.academyinvaders.entities;

import java.util.LinkedList;
import org.codeforall.academyinvaders.Main;
import org.codeforall.academyinvaders.bullets.PlayerBullet;
...
import org.codeforall.academyinvaders.system.PlayerKeyboard;
  ...
  public void playDestroyedAnimationIfDestroyed() {
    ...
    if (isDestroyed() && doAnimationCounter) {
      ...
      destroyedAnimation.playPlayerAnimation(
          "org/codeforall/academyinvaders/GameObjects/assets/ExplosionEffects/exp.1.png", delay);

      destroyedAnimation.playPlayerAnimation(
          "org/codeforall/academyinvaders/GameObjects/assets/ExplosionEffects/exp.2.png", delay);

      destroyedAnimation.playPlayerAnimation(
          "org/codeforall/academyinvaders/GameObjects/assets/ExplosionEffects/exp.3.png", delay);

      destroyedAnimation.playPlayerAnimation(
          "org/codeforall/academyinvaders/GameObjects/assets/ExplosionEffects/exp.4.png", delay);

      destroyedAnimation.playPlayerAnimation(
          "org/codeforall/academyinvaders/GameObjects/assets/ExplosionEffects/exp.5.png", delay);

      destroyedAnimation.playPlayerAnimation(
          "org/codeforall/academyinvaders/GameObjects/assets/ExplosionEffects/exp.6.png", delay);

      destroyedAnimation.playPlayerAnimation(
          "org/codeforall/academyinvaders/GameObjects/assets/ExplosionEffects/exp.7.png", delay);

      destroyedAnimation.playPlayerAnimation(
          "org/codeforall/academyinvaders/GameObjects/assets/ExplosionEffects/exp.8.png", 250);

      this.getPlayerPosition().getObject().delete();

      Picture gameOver = new Picture(300, 300,
          "org/codeforall/academyinvaders/GameObjects/assets/TitlesAndSubtitles/game_over_title.png");
