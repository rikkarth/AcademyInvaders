...
import org.codeforall.academyinvaders.grid.position.AbstractGridPosition;
    ...
    switch (face) {
      case PLAYER:
        objectPicture = new Picture(width, height,
            "src/main/resources/ships/player_ship.png");
        break;
      case BULLET:
        //object = new Rectangle(width + grid.getGridX(), height + grid.getGridY(), sizeX, sizeY);
        objectPicture = new Picture(width, height,
            "src/main/resources/bullets/binary_bullet.png");
        break;
      case BULLETGREEN:
        objectPicture = new Picture(width, height,
            "src/main/resources/bullets/greenbullet_energy_small.png");
        break;
      case BALJEET:
        objectPicture = new Picture(width, height,
            "src/main/resources/ships/monster_octupus.png");
        break;
    }
