    ...
    if (
        player.getPlayerPosition().getWidth() < bulletPosition.getWidth() + bulletPosition.getObjectWidth() &&
            player.getPlayerPosition().getWidth() + player.getPlayerPosition().getObjectWidth()
                > bulletPosition.getWidth() &&
            player.getPlayerPosition().getHeight() < bulletPosition.getHeight() + bulletPosition.getObjectHeight() &&
            player.getPlayerPosition().getObjectHeight() + player.getPlayerPosition().getHeight()
                > bulletPosition.getHeight()
    ) {
      // Collision detected!
  ...
  public boolean ifCollided(Enemy enemy) {
    if (
        enemy.getEnemyPosition().getWidth() < bulletPosition.getWidth() + bulletPosition.getObjectWidth() &&
            ...
            enemy.getEnemyPosition().getObjectHeight() + enemy.getEnemyPosition().getHeight()
                > bulletPosition.getHeight()
    ) {
      // Collision detected!
      //System.out.println("Collided");
