...
import main.java.org.academiadecodigo.academyinvaders.GameObjects.Grid.GridColor;
import main.java.org.academiadecodigo.academyinvaders.GameObjects.Grid.Grid;
...
public abstract class AbstractGridPosition implements GridPosition {
    ...
    public void moveDown(int distance) {
        ...
        int maxDownHeight = distance > getGrid().getGRID_HEIGHT() - getHeight()+40 ? getGrid().getGRID_HEIGHT() - getHeight()+40 : distance;
    ...
    public void moveRight(int distance) {
        ...
        int maxRightWidth = distance > getGrid().getGRID_WIDTH() - getWidth()+130 ? getGrid().getGRID_WIDTH() - getWidth()+130 : distance;
