    ...
    switch (face) {
      ...
      case GAME:
        ...
        this.gridfill = new Picture(PADDING + 200, PADDING + 100,
            "org/academiadecodigo/academyinvaders/GameObjects/assets/Backgrounds/blackhole.jpeg");

        //<<<<<<<<<<<<<<<<<<<<<<<<<<<<center elements>>>>>>>>>>>>>>>>>>>><<
        this.arcadetitle = new Picture(474, 0,
            "org/academiadecodigo/academyinvaders/GameObjects/assets/TitlesAndSubtitles/academytitle.png");
        //<<<<<<<<<<<<<<<<left side elements>>>>>>>>>>>>>>>>>>>>>>>>>>>
        this.scoreTitle = new Picture(17, 200,
            "org/academiadecodigo/academyinvaders/GameObjects/assets/TitlesAndSubtitles/score_subtitle.png");
        this.healthPlayer = new Picture(15, 400,
            "org/academiadecodigo/academyinvaders/GameObjects/assets/TitlesAndSubtitles/live_status_title.png");
        this.healthStatusBar = new Picture(10, 480,
            "org/academiadecodigo/academyinvaders/GameObjects/assets/bar/100percent_bar.png");
        this.scoreBar = new Picture(10, 270,
            "org/academiadecodigo/academyinvaders/GameObjects/assets/bar/score_box.png");
        //<<<<<<<<<<<<<right side elements<<<<<<<<<<<<<<<<<<<<<<<<<
        this.enemyhealthtitle = new Picture(1250, 400,
            "org/academiadecodigo/academyinvaders/GameObjects/assets/TitlesAndSubtitles/enemy_heath_subtitle.png");
        this.enemyhealthbar = new Picture(1235, 480,
            "org/academiadecodigo/academyinvaders/GameObjects/assets/bar/shield_error_bar.png");
        this.level = new Picture(1240, 200,
            "org/academiadecodigo/academyinvaders/GameObjects/assets/TitlesAndSubtitles/small_level_one.png");
        break;
    }
  }
